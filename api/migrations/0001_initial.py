    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('univ_key', models.CharField(max_length=300, unique=True, verbose_name='University key')),
                ('adress', models.CharField(max_length=500, verbose_name='adress')),
                ('city', models.CharField(max_length=500, verbose_name='Wilaya in algeria')),
        ...
        migrations.AddField(
            model_name='member',
            name='level',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.userlevels', verbose_name='user study level and field'),
        ),
        migrations.AddField(
            model_name='member',
