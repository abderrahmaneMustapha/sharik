...
import { TagTextInput } from "../../inputs/index";

export default function EventCreationForm(props) {
    const {data:tags, loading:tags_loading} = useQuery(ALL_TAGS)
        ...
        <>
            ...
            <Form encType={"multipart/form-data"}>
                ...
                <Field
                    name="startAt"
                    label="startAt"
                    value={startAt_value.toString()}
                >
                    <DateInput
                        name="startAt"
                        format="YYYY-MM-DD"
                        onChange={(value) => {
                            let newdate = moment(value.value).format(
                                "YYYY-MM-DD"
                            );
                            SetStartAt(newdate);
